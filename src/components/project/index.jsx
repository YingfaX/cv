...
const ListItem = ({ time, title, authors, description }) => (
    <li className="mb-5 ml-4">
      ...
      <h5 className="mb-2 font-normal">{authors}</h5>
      <div className="mb-4 font-normal">{description}</div>
    </li>
);
const Project = ({ repo, loading, github, googleAnalytics, researches }) => {
                ...
                <div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="text-base-content text-opacity-60">
                      <ol className="relative border-l border-opacity-30 my-2 mx-4">
                        {loading ? (
                            renderResearch()
                        ) : (
                            <Fragment>
